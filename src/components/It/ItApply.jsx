...
const ItApply = () => {
  const steps = useMemo(() => [1, 2, 3, 4, 5], []);

  const stepCircleStyle = {
    backgroundColor: "#001E5D",
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h2 className="text-3xl md:text-4xl font-semibold text-[#390161] mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mx-auto">
          {steps.map((step) => (
            <div
              key={step}
              className="relative bg-[#390161] p-6 shadow-xl w-full will-change-transform"
            >
              <div
