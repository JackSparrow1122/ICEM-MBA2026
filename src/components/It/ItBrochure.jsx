      ...
      <div className="w-full bg-[#390161] p-4 rounded-3xl flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="mt-2 md:mt-4">
          <a
            ...
            className="bg-[#390161] border-2 border-[#390161] text-white px-6 py-3 rounded-3xl  border-white hover:border-white transition duration-300 flex items-center space-x-2"
          >
