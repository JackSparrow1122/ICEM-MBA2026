    ...
    >
      <div className="w-full bg-[#F37121] p-6 rounded-3xl flex flex-col md:flex-row justify-between items-center">
        ...
        <a
          ...
          className="bg-[#D75A13] border-2 border-white text-white px-6 py-3 rounded-3xl hover:bg-[#F37121] transition duration-300 flex items-center space-x-2 cursor-pointer"
        >
