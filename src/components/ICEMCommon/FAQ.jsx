...
const FAQ = () => {
    ...
    about: {
      ...
      questions: [
        ...
        },
        {
          id: 2,
          question:
            "What are the benefits of studying at an Autonomous engineering college?",
          answer:
            "Autonomy allows ICEM to offer an industry-aligned syllabus, incorporate emerging technologies (like Generative AI, Cloud Computing, and IoT) into the core coursework, conduct exams on time, publish results quickly, and offer flexible credit-based choice systems that enhance employment readiness.",
        },
        {
          id: 3,
          question:
      ...
      questions: [
        {
          id: 4,
          question:
            "What is the eligibility criteria for first-year B.E. admissions?",
          answer:
        ...
        },
        {
          id: 5,
          question:
            "Does ICEM offer Direct Second Year (DSE) admissions for diploma holders?",
          answer:
            "Yes, diploma holders who have completed an AICTE-approved Diploma in Engineering & Technology with at least 45% marks (40% for reserved category/Maharashtra PWD) are eligible for Direct Second Year (DSE) admission through the CAP rounds.",
        },
        {
          id: 6,
          question:
          ...
          answer:
            "Absolutely! We highly encourage students and parents to visit the campus for a guided tour of our labs, library, and hostels. Our admission counselling center is open Monday to Saturday from 9:30 AM to 5:30 PM. You can also connect with us online.",
        },
      ],
    },
    fees: {
      ...
      questions: [
        {
          id: 10,
          question:
            "What is the placement record and highest package offered at ICEM?",
          answer:
            "ICEM has a robust placement record. The highest package offered is 27 LPA, with average packages ranging between 4.5 LPA and 6 LPA. Our graduates are placed in top-tier multinational companies, core engineering firms, and emerging startups.",
        },
        {
          id: 11,
          question: "Who are the primary recruiters visiting the ICEM campus?",
          answer:
            "Our regular campus recruiters include industry giants and tech leaders such as Emerson, CrowdStrike, Tetra Pak, Forbes Marshall, TCS, Capgemini, Cognizant, Wipro, Infosys, and Tech Mahindra.",
        },
        {
          id: 12,
          question:
          ...
          answer:
            "Our dedicated T&P Cell conducts structured grooming programs starting from the second year. This includes training in soft skills, business communication, aptitude solving, programming bootcamps, resume-building workshops, and mock interview drills conducted by industry experts.",
        },
      ],
    },
    infrastructure: {
      ...
      questions: [
        {
          ...
          answer:
            "ICEM is equipped with advanced laboratories, including specialized Apple Mac Labs, high-performance computing labs, mechanical engineering workshops, electronics and IoT testbeds, and modern chemistry/physics laboratories designed to encourage research and practical learning.",
        },
        {
          id: 14,
  ...
  return (
    <section
      className="py-16 md:py-24 bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9] px-4 sm:px-6 lg:px-8 border-t border-[#e2e8f0]"
      id="faq"
    >
                      ...
                      >
                        <div className="flex-1">
                          <h4
                            className={`text-sm md:text-base font-bold transition-colors duration-300 leading-snug ${
                              isOpen
                                ? "text-[#003c84]"
                                : "text-gray-800 group-hover:text-[#259CA8]"
                            }`}
                          >
                            {item.question}
                          </h4>
                        ...
                        <div
                          className={`flex-shrink-0 mt-0.5 p-1 rounded-full bg-slate-100 text-gray-500 transition-all duration-300 ${
                            isOpen
                              ? "rotate-180 bg-[#259CA8]/10 text-[#259CA8]"
